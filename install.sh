...
chmod +x ~/.config/scripts/hyprlock-greeter.sh ~/.config/scripts/wireless-menu.sh ~/.config/scripts/waybar-weather.sh ~/.config/scripts/notify.sh ~/.config/scripts/bongocat-cat.sh ~/.config/scripts/wofi-theme.sh ~/.config/scripts/switch-theme ~/.config/scripts/openwebui-post.sh ~/.config/scripts/hyprlock-weather.sh
